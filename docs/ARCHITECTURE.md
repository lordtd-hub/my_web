...
การวัดผลประเมินผลของแต่ละรายวิชาควรต่อผ่าน contract กลาง ไม่เขียน logic เฉพาะ `SMAC001` หรือสื่อ Cal1 ลงใน core app โดยตรง
...
แนวคิดหลักคือให้แต่ละรายวิชาเป็น course template ที่ประกาศ:
...
`SMAC001 แคลคูลัส 1` ใช้เป็น pilot ได้ แต่ CLO, Bloom mapping, rubric, XP และ badge ต้องเป็นข้อมูลรายวิชาที่เสียบเข้ากับ contract กลาง เพื่อให้รายวิชาอื่นเพิ่มตามโครงเดียวกันได้ในภายหลัง
...
/student/courses/:courseId/self-assessment
...
หน้า `/student/courses/:courseId/activities` เป็น activity catalog แบบอ่านอย่างเดียวสำหรับผู้เรียนที่ลงทะเบียนในรายวิชานั้นแล้ว ใน phase แรกจะแสดงเฉพาะสื่อ practice และ external resources ยังไม่เขียน `activityAttempts`, `studentProgress` หรือคะแนนทางการ
